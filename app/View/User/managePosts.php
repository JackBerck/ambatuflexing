                ...
                <?php foreach ($posts as $post): ?>
                    <div class="shadow-sm shadow-purple-base rounded-lg p-2 relative">
                        <div class="flex gap-2 items-center absolute top-2 right-2">
                            <a href="#" class="bg-purple-base p-2 rounded-full">
                                <svg
                        ...
                        <div class="flex gap-2 items-center mb-2">
                            <img
                                    src={post.user.image}
                                    alt={`${post.user.name} Photo Profile`}
                                    class="w-8 md:w-10 aspect-square rounded-full object-cover"
                            />
                            <div class="">
                                <h6 class="normal-font-size font-bold">{post.user.name}</h6>
                                <p class="small-font-size">{post.user.role}</p>
                            </div>
                        </div>
                        <div class="mb-2">
                            <a href="">
                        ...
                        <div class="flex justify-end items-center gap-2">
                            <p class="small-font-size">2 jam yang lalu</p>
                            <button class="flex items-center gap-2">
                                ...
                                <span class="normal-font-size">{post.post.like}</span>
                            </button>
                            <button class="flex items-center gap-2">
                                <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                ...
                                <span class="normal-font-size">{post.post.comment}</span>
                            </button>
                        </div>
                    </div>
                <?php endforeach; ?>
